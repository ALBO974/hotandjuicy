...
const episodes = [
   {
     ...
     number:      69,
     type:        "full",
     title:       "Kenyans in Dubai: What Really Happens When Jobs Disappear?",
     slug:        "kenyans-in-dubai-kemboi-kujiuza",
     youtubeId:   "R0Z3ltddn94",
    ...
    showNotes:   "Job loss, survival, and the truth about working abroad — Kemboi Kujiuza shares what really happens when the work disappears.",
    transcript:  "",
    topics:      ["Jobs in Dubai", "Life abroad", "Kemboi Kujiuza"],
    tags:        ["live", "recording"],
    duration:    "42 min",
  ...
  },
   {
    ...
    showNotes:   "We break down how to build an expensive look on a real budget — style rules, where to spend, where to save, and the confidence that comes with it.",
    transcript:  "",
    topics:      ["Dressing on a budget", "Style rules", "Where to spend vs save", "Confidence"],
    tags:        ["fashion", "style", "modern life"],
    duration:    "64 min",
